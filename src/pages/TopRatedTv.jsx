...
import TvItem from "../components/Search/SearchItemTv";
...
export const TopRatedTvLoader = async ({ params }) => {
  const url = `https://api.themoviedb.org/3/tv/top_rated?page=${params.page}`;
  const options = {
    method: "GET",
    headers: {
